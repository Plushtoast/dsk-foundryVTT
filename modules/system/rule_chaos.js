...
export default class RuleChaos {
    ...
    static multipleDefenseValue(actor, item) {
        ...
        if ((getProperty(item, "system.combatskill") == game.i18n.localize("dsk.dsk.LocalizedIDs.wrestle")) && SpecialabilityRulesDSK.hasAbility(actor, game.i18n.localize("dsk.LocalizedIDs.masterfulDodge")))
            multipleDefense = -2
