...
export default class ActorSheetCreature extends ActorSheetDSK{
    ...
    async getData(options) {
        ...
        data.enrichedBehaviour = await TextEditor.enrichHTML(getProperty(this.actor.system, "fight"), {secrets: true, async: true})
        data.enrichedSpecialrules = await TextEditor.enrichHTML(getProperty(this.actor.system, "specialRules"), {secrets: true, async: true})
        return data;
    }
